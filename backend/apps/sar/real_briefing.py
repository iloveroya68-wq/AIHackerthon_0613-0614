...
def _build_messages(
    ...
    system = (
        ...
        "4. 유효한 JSON 객체만 반환하세요. 설명 문장이나 마크다운은 금지입니다.\n"
    )
...
{zone_line}
L3 보정: {'적용 완료' if engine.l3_correction_applied else '미적용'} (학습 유사사고 {engine.similar_incidents_count}건)
...
{{
  ...
  "sections": [
    {{"section_id": 1, "title": "현재 표류 예측 요약", "body": "...", "sources": ["L2", "L3"]}},
    {{"section_id": 2, "title": "과거 유사 사고 비교", "body": "참조한 incident_id를 인용하여 작성...", "sources": ["RAG"]}},
    {{"section_id": 3, "title": "수색 구역 권고 근거", "body": "...", "sources": ["L2", "L3", "RAG"]}},
